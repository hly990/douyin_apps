...
export interface ApiAuthTestAuthTest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    testType: Schema.Attribute.Enumeration<['public', 'private', 'mixed']> &
...
export interface ApiAuthAuth extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'\u63D0\u4F9B\u767B\u5F55\u3001\u6CE8\u518C\u3001Token\u9A8C\u8BC1\u7B49\u670D\u52A1'>;
    enabled: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::auth.auth'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u8BA4\u8BC1\u670D\u52A1'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiUserUser extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    avatarUrl: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://via.placeholder.com/150'>;
    bio: Schema.Attribute.Text;
    collections: Schema.Attribute.Relation<'oneToMany', 'api::video.video'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email & Schema.Attribute.Unique;
    followers: Schema.Attribute.Relation<'manyToMany', 'api::user.user'>;
    following: Schema.Attribute.Relation<'manyToMany', 'api::user.user'>;
    lastLoginAt: Schema.Attribute.DateTime;
    likes: Schema.Attribute.Relation<'oneToMany', 'api::video.video'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::user.user'> &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    nickname: Schema.Attribute.String;
    openid: Schema.Attribute.String & Schema.Attribute.Unique;
    password: Schema.Attribute.Password &
      Schema.Attribute.Required &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
...
export interface ApiVideoCollectionVideoCollection
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    collectedAt: Schema.Attribute.DateTime & Schema.Attribute.DefaultTo<'now'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiVideoLikeVideoLike extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    likedAt: Schema.Attribute.DateTime & Schema.Attribute.DefaultTo<'now'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::auth-test.auth-test': ApiAuthTestAuthTest;
